...
import { FaStar, FaBook, FaUser, FaCalendar, FaClock } from "react-icons/fa6";
export default function CardItem() {
    return (
        <>  <Link href="/">
                <div className="bg-white rounded-[10px]">
                    <div className=''>
                        <img src="/src/assets/images/course_img_demo.png" className='rounded-tr-[5px] rounded-tl-[5px]'>
                        </img>
                    </div>
                    <div className="px-[25px] py-[20px] rounded-bl-[10px] rounded-br-[10px]">
                        ...
                        <div className='card_title'>
                            <h4 className="text-[18px] font-[700] mb-[15px] text-primary">Lập trình node JS</h4>
                            ...
                            <div className='flex justify-start gap-[10px] items-center'>
                                <div className=''>
                                    <img className='max-w-[40px] w-[40px] height-[40px] object-cover rounded-full border-2 border-primary__opacity pd-[2px]' src="/src/assets/images/avatar_demo.png"></img>
                                </div>
