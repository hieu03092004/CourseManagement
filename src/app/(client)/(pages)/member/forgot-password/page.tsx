...
export default function ForgotPasswordPage() {
  const inputClass =
    "block w-full pl-10 pr-4 py-2.5 text-base border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out";

  const labelClass =
    "block text-base font-medium text-gray-700 after:content-['*'] after:ml-0.5 after:text-red-500";
            ...
            >
              ...
              <div className="flex-grow">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Gửi mã xác nhận đến địa chỉ email đã đăng ký của bạn.
                </p>
              </div>
